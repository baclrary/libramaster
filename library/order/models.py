...
class Order(models.Model):
    """
       ...
       """
    book = models.ForeignKey(Book, on_delete=models.CASCADE, default=None, verbose_name="Ordered book")
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, default=None)
    created_at = models.DateTimeField(auto_now_add=True)
    end_at = models.DateTimeField(default=None, null=True, blank=True, verbose_name="Returned at")
    plated_end_at = models.DateTimeField(default=None, verbose_name="Should be returned until")
    ...
    def close(self):
        self.user.books.remove(self.book)
        self.book.count += 1
        self.book.save()
